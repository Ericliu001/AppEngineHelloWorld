 ...
 * on 2015-10-26 at 10:01:18 UTC 
 * Modify at your own risk.
 */

package com.example.ericliu.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://ericliu-hello-world.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "sayGoodMorning".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SayGoodMorning#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public SayGoodMorning sayGoodMorning(java.lang.String name) throws java.io.IOException {
    SayGoodMorning result = new SayGoodMorning(name);
    initialize(result);
    return result;
  }

  public class SayGoodMorning extends MyApiRequest<com.example.ericliu.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "sayGoodMorning/{name}";
     ...
     * parameters, call the {@link SayGoodMorning#execute()} method to invoke the remote operation.
     * <p> {@link SayGoodMorning#initialize(com.google.api.client.googleapis.services.AbstractGoogleCl
     ...
     * @since 1.13
     */
    protected SayGoodMorning(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.ericliu.myapplication.backend.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public SayGoodMorning setAlt(java.lang.String alt) {
      return (SayGoodMorning) super.setAlt(alt);
    }

    @Override
    public SayGoodMorning setFields(java.lang.String fields) {
      return (SayGoodMorning) super.setFields(fields);
    }

    @Override
    public SayGoodMorning setKey(java.lang.String key) {
      return (SayGoodMorning) super.setKey(key);
    }

    @Override
    public SayGoodMorning setOauthToken(java.lang.String oauthToken) {
      return (SayGoodMorning) super.setOauthToken(oauthToken);
    }

    @Override
    public SayGoodMorning setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SayGoodMorning) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SayGoodMorning setQuotaUser(java.lang.String quotaUser) {
      return (SayGoodMorning) super.setQuotaUser(quotaUser);
    }

    @Override
    public SayGoodMorning setUserIp(java.lang.String userIp) {
      return (SayGoodMorning) super.setUserIp(userIp);
    }
    ...
    public SayGoodMorning setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public SayGoodMorning set(String parameterName, Object value) {
      return (SayGoodMorning) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.ericliu.myapplication.backend.myApi.model.MyBean> {
